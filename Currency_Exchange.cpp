...
bool isConvertible(int c1, int c2) {
    int gold=5;
    int silver=1;
    int remov=gold+silver;
    return c1 >= c2 && (c1 - c2) % remov == 0;
}
...
void solve() {
    ...
    int change1 = prod(a1, b1);
    int change2 = prod(a2, b2);

    if (isConvertible(change1, change2)) {
        cout << "YES\n";
    } else {
        cout << "NO\n";
    }
